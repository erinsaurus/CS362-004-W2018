/* 
 ...
 Description: Assignment 3. cardtest1

   Testing Smithy Card
   Expected results:
   		- Current player receives 3 cards
   		- The 3 cards come from his own pile
   			- Total handcount +2 (+3 cards - 1 Smithy)
   			- Total deckcount decreased by 3
...
int main() {
	...
	printf("TEST 2: Three cards are drawn from the current player's deck.\n");

	printf("deck count = %d, expected = %d\n", testG.deckCount[thisPlayer], G.deckCount[thisPlayer] - 3 + shuffledCards);

	if(testG.deckCount[thisPlayer] != (G.deckCount[thisPlayer] - 3 + shuffledCards))
	{
