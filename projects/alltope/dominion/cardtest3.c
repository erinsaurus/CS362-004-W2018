/* 
 ...
 Description: Assignment 3. cardtest3

   Testing Village Card
   Expected results:
   		- Current player receives 2 actions
   		- Handcount increased by 1
   		- Deckcount decreased by 1
...
int main() {
	...
	// ----------- TEST 1: current player receives 1 cards cards --------------
	...
	printf("hand count = %d, expected = %d\n", testG.handCount[thisPlayer], G.handCount[thisPlayer] + 0); // 1 card drawn - 1 card discarded = 0 new cards
	...
	//-------------TEST 2: Card is drawn from the current player's deck ----------
	printf("TEST 2: One card is drawn from the current player's deck.\n");

	printf("deck count = %d, expected = %d\n", testG.deckCount[thisPlayer], G.deckCount[thisPlayer] - 1 + shuffledCards);

	if(testG.deckCount[thisPlayer] != (G.deckCount[thisPlayer] - 1 + shuffledCards))
	{
	...
	//-----------TEST 4: Current player played pile increased by 1-------------

	printf("TEST 4: Played pile of current player increased by 1.\n");
	...
	printf("TEST 6: No state change in Victory and Kingdom Cards.\n");
